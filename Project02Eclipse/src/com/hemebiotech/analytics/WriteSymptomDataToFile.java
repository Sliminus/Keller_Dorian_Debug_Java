...
public class WriteSymptomDataToFile implements ISymptomWriter {
    ...
    public void writeSymptoms( Map<String, Integer> occurrences, List<String> clesTriees) throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\Dorian\\IdeaProjects\\Keller_Dorian_Debug_Java\\Project02Eclipse\\src\\com\\hemebiotech\\analytics\\result.out"))) {
